...
#                 f2.write(line)
#
df = pd.read_csv("adult_train.txt", sep=',', header=None,
...
for i in final_df.columns:
    print("'"+i+"',")
# print(df)
# X0 = final_df[final_df['label'] == 0].sample(n = 1000,random_state=1)
# X1 = final_df[final_df['label'] == 1].sample(n = 1000,random_state=1)
#Xall = pd.concat([X0, X1], axis=0)
X = final_df[
